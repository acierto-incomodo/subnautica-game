...
BASE_URL_WIN = "https://github.com/acierto-incomodo/subnautica-game/releases/latest/download/Build.zip"
BUILD_URL_LINUX = "https://github.com/acierto-incomodo/subnautica-game/releases/latest/download/Build.zip"
VERSION_URL = "https://github.com/acierto-incomodo/subnautica-game/releases/latest/download/version.txt"
RELEASE_NOTES_URL = "https://github.com/acierto-incomodo/subnautica-game/releases/latest/download/ReleaseNotes.txt"
URL_7ZR = "https://github.com/acierto-incomodo/subnautica-game/releases/latest/download/7zr.exe"

EXE_NAME_WIN   = "Build/Subnautica.exe"
EXE_NAME_LINUX = "Build/Subnautica.exe"
...
class LauncherWindow(QtWidgets.QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Subnautica - Launcher")
    ...
    def setup_ui(self):
        ...
        title = QtWidgets.QLabel("Subnautica")
